<template>
  <section id="about" class="section has-text-centered">
    <div class="container">
      ...
      <p data-aos="fade-up">
        パーソナルトレーニングスタジオBeeではお客様の目標を達成、維持できるようマンツーマンでトレーニングします。知識、経験豊富なトレーナー陣が最適なトレーニング方法でお客様のボディメイクにアプローチします。また、清潔で明るいシャワールームとパウダールームをご用意しております。<br>今まで運動が続かなかった方も自分にあったトレーニングで理想のボディを創りあげましょう！</p>
